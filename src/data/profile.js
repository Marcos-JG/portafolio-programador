export const profile = {
  ...
  description:
    'Construyo aplicaciones web modernas con React, Node.js, Express, MongoDB y Tailwind CSS. Enfocado en crear experiencias digitales limpias, accesibles y con buen rendimiento.',
  about: [
