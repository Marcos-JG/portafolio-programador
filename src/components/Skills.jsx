...
const icons = {
  ...
  arrows: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5',
  ...
  layers: 'M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z',
...
export default function Skills() {
  return (
    <section id="skills" className="bg-neutral-50/50 px-6 py-24 dark:bg-neutral-900/50">
      <div className="mx-auto max-w-6xl">
        <SectionTitle title="Habilidades e Intereses" subtitle="Lo que aporto y lo que me apasiona" />

        <div className="grid gap-8 md:grid-cols-2">
          {skills.map((group) => (
            <ScrollReveal key={group.category}>
              <div className="rounded-2xl border border-neutral-200/60 bg-white p-8 dark:border-neutral-800/60 dark:bg-neutral-950">
                <h3 className="mb-6 text-xs font-semibold tracking-widest text-indigo-500 dark:text-indigo-400">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {group.items.map((item) => (
                    <div
                      key={item.name}
                      className="flex items-center gap-3 rounded-xl border border-neutral-100 bg-neutral-50/50 px-4 py-3 transition-all hover:border-indigo-100 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-indigo-900"
                    >
                      <svg
